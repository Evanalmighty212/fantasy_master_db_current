...
_COLUMN_REGISTRY = [
    {"canonical_column": "outcome_season", "meaning": "The real season the outcome describes (never a lagged/prediction season -- this artifact is outcomes only)."},
    {"canonical_column": "player_id", "meaning": "gsis_id, matches the predictor table's own player_id."},
    {"canonical_column": "position", "meaning": "From the master population."},
    {"canonical_column": "real_status", "meaning": "The granular real SBV status, or 'no_sbv_row_found' -- never an aggregated category."},
    {"canonical_column": "has_real_market_adp", "meaning": "True iff a real fantasy market ADP exists (overall_adp non-null)."},
    {"canonical_column": "adp_round", "meaning": "ceil(overall_adp / TEAMS), via lib.stars_by_value.expected_production.adp_round() -- null if no real ADP."},
    {"canonical_column": "star_outcome_eligible", "meaning": "True wherever a real, non-null star_by_value_label exists -- includes below_production_gate (real, deliberate label=False)."},
    {"canonical_column": "star_outcome_ineligibility_reason", "meaning": "Null iff eligible; else one of: out_of_scope_temporal_window, zero_games_excluded_from_sbv_population, acquisition_cost_unresolved_drafted, acquisition_cost_unresolved_ambiguous, expected_production_lookup_out_of_range."},
    {"canonical_column": "star_by_value_label", "meaning": "Real, nullable boolean -- False is a real, deliberate value (below_production_gate), never confused with <NA> (ineligible)."},
    {"canonical_column": "sbv_score_available", "meaning": "True only for adp_scored/minimal_market_cost_scored -- SEPARATE from star_outcome_eligible; a below-gate row is eligible with no score."},
    {"canonical_column": "star_by_value_score", "meaning": "Real SBV score, only where sbv_score_available."},
    {"canonical_column": "bust_primary_eligible", "meaning": "True iff real market ADP AND outcome_season >= 2010. Does NOT require clearing SBV's production gate."},
    {"canonical_column": "bust_primary_ineligibility_reason", "meaning": "Null iff eligible; else one of: pre_2010_temporal_window_real_adp, mmc_no_real_adp_round_peer_group, acquisition_cost_unresolved_drafted, acquisition_cost_unresolved_ambiguous, no_real_fantasy_adp_below_production_gate, no_real_fantasy_adp_pre_2010, zero_games_nfl_draft_capital_not_fantasy_adp, zero_games_no_valid_cost_signal."},
    {"canonical_column": "bust_primary_label", "meaning": "RESERVED, always <NA> this round -- no approved percentile threshold exists yet for definition G."},
    {"canonical_column": "bust_strict_eligible", "meaning": "Same population as bust_primary_eligible (definition I adds an absolute-floor THRESHOLD, not a separate eligibility gate)."},
    {"canonical_column": "bust_strict_ineligibility_reason", "meaning": "Same as bust_primary_ineligibility_reason."},
    {"canonical_column": "bust_strict_label", "meaning": "RESERVED, always <NA> this round -- no approved absolute-floor value exists yet for definition I."},
    {"canonical_column": "bust_historical_sensitivity_eligible", "meaning": "True iff real market ADP, WITHOUT the >=2010 restriction -- a named, explicit sensitivity population including the 521 real pre-2010-ADP rows."},
    {"canonical_column": "bust_historical_sensitivity_ineligibility_reason", "meaning": "Same reason vocabulary as bust_primary, minus the pre-2010 branch (never fires here)."},
    {"canonical_column": "bust_historical_sensitivity_label", "meaning": "RESERVED, always <NA> this round."},
    {"canonical_column": "underperformance_diagnostic_eligible", "meaning": "True for adp_scored/minimal_market_cost_scored/below_production_gate WITH a real, non-extrapolated E_P value. Computed before any production-gate check."},
    {"canonical_column": "underperformance_diagnostic_ineligibility_reason", "meaning": "Null iff eligible; else one of: outside_diagnostic_population, expected_production_lookup_out_of_range, production_composite_unavailable."},
    {"canonical_column": "underperformance_diagnostic_value", "meaning": "Real P - E_P (raw, unweighted -- NOT the same as star_by_value_score, which uses SBV_LAMBDA). Null unless eligible."},
]
